var EXPLOSION_TIME = 1000// how long explosion fire remains on map
var EXPANSION_TIME = 95; // how fast explosion fire expands
var EXTINCTION_TIME = 60; // how fast explosion fire extincs
					...
					case "destructable":
						...
						if(bomb.map.getCrateCount() < 2)
							game.time.events.add(1500, function(){
								if(IS_HOST) SOCKET.emit('map reset');
							}, this);
						break;
				}
			}
